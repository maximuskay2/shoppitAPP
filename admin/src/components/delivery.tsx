...
import { BiMapAlt, BiTrendingUp, BiUser } from "react-icons/bi";
...
type TabKey = "map" | "analytics" | "agents";
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4">
        ...
        <p className="text-sm text-gray-600 mt-1">
          Monitor live driver locations, view analytics, and manage driver verification
        </p>
      </div>
