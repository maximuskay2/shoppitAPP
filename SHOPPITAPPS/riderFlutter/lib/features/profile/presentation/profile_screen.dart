...
class _ProfileScreenState extends State<ProfileScreen> {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(onPressed: () => Navigator.pop(ctx, true), child: const Text("Log Out", style: TextStyle(color: kErrorColor))),
        ],
      ),
    );
  ...
  Future<void> _showDeleteAccountDialog() async {
    final confirmed = await showDialog<bool>(
      context: context,
      builder: (ctx) => AlertDialog(
        title: const Text("Delete Account", style: TextStyle(color: kErrorColor)),
        content: const Text(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: const Text("Contact Support", style: TextStyle(color: kPrimaryColor)),
          ),
        ],
      ),
    );
    if (confirmed != true || !mounted) return;
    // TODO: Open support/help or email - for now just dismiss
    if (mounted) {
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        label: const Text("Delete Account", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16, color: kErrorColor)),
                        style: OutlinedButton.styleFrom(
