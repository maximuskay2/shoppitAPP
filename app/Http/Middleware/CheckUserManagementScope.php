...
class CheckUserManagementScope
{
    /**
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        // Check if admin has wildcard privilege or user-management scope
        if (in_array('*', $permissions) || in_array('user-management', $permissions)) {
            return $next($request);
        }

        return ShopittPlus::response(false, 'Access denied. User management privilege required.', 403);
    }
}
