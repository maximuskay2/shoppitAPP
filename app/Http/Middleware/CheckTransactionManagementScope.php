...
class CheckTransactionManagementScope
{
    /**
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        // Check if admin has wildcard privilege or transaction-management scope
        if (in_array('*', $permissions) || in_array('transaction-management', $permissions)) {
            return $next($request);
        }

        return ShopittPlus::response(false, 'Access denied. Transaction management privilege required.', 403);
    }
}
