...
class CheckReportsManagementScope
{
    /**
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        // Check if admin has wildcard privilege or reports-management scope
        if (in_array('*', $permissions) || in_array('reports-management', $permissions)) {
            return $next($request);
        }

        return ShopittPlus::response(false, 'Access denied. Reports management privilege required.', 403);
    }
}
