...
class UserManagementController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            return ShopittPlus::response(true, 'Users retrieved successfully', 200, $users);
        } catch (InvalidArgumentException $e) {
            Log::error('LIST USERS: Error Encountered: ' . $e->getMessage());
            return ShopittPlus::response(false, $e->getMessage(), 400);
        } catch (Exception $e) {
            Log::error('LIST USERS: Error Encountered: ' . $e->getMessage());
            return ShopittPlus::response(false, 'Failed to retrieve users', 500);
        }
    }
    ...
    public function stats(): JsonResponse
    {
        try {
            ...
            return ShopittPlus::response(false, 'Failed to retrieve user statistics', 500);
        }
    }
    ...
    public function store(CreateUserRequest $request): JsonResponse
    {
        try {
            ...
            Log::error('CREATE USER: Error Encountered: ' . $e->getMessage());
            return ShopittPlus::response(false, 'Failed to create user', 500);
        }
    }
    ...
    public function show(string $id): JsonResponse
    {
        try {
            ...
            Log::error('GET USER DETAILS: Error Encountered: ' . $e->getMessage());
            return ShopittPlus::response(false, 'Failed to retrieve user details', 500);
        }
    }
    ...
    public function update(UpdateUserRequest $request, string $id): JsonResponse
    {
        try {
            ...
            Log::error('UPDATE USER: Error Encountered: ' . $e->getMessage());
            return ShopittPlus::response(false, 'Failed to update user', 500);
        }
    }
    ...
    public function destroy(string $id): JsonResponse
    {
        try {
            ...
            return ShopittPlus::response(true, 'User deleted successfully', 200);
        } catch (InvalidArgumentException $e) {
            Log::error('DELETE USER: Error Encountered: ' . $e->getMessage());
            return ShopittPlus::response(false, $e->getMessage(), 400);
        } catch (Exception $e) {
            Log::error('DELETE USER: Error Encountered: ' . $e->getMessage());
            return ShopittPlus::response(false, 'Failed to delete user', 500);
        }
    }
    ...
    public function suspend(string $id): JsonResponse
    {
        try {
            ...
            Log::error('SUSPEND USER: Error Encountered: ' . $e->getMessage());
            return ShopittPlus::response(false, 'Failed to suspend user', 500);
        }
    }
    ...
    public function activate(string $id): JsonResponse
    {
        try {
            ...
            Log::error('ACTIVATE USER: Error Encountered: ' . $e->getMessage());
            return ShopittPlus::response(false, 'Failed to activate user', 500);
        }
    }
    ...
    public function changeStatus(ChangeUserStatusRequest $request, string $id): JsonResponse
    {
        try {
            ...
            Log::error('CHANGE USER STATUS: Error Encountered: ' . $e->getMessage());
            return ShopittPlus::response(false, 'Failed to change user status', 500);
        }
    }
    ...
    public function transactions(Request $request, string $id): JsonResponse
    {
        try {
            ...
            return ShopittPlus::response(true, 'User transactions retrieved successfully', 200, $transactions);
        } catch (InvalidArgumentException $e) {
            Log::error('GET USER TRANSACTIONS: Error Encountered: ' . $e->getMessage());
            return ShopittPlus::response(false, $e->getMessage(), 400);
        } catch (Exception $e) {
            Log::error('GET USER TRANSACTIONS: Error Encountered: ' . $e->getMessage());
            return ShopittPlus::response(false, 'Failed to retrieve user transactions', 500);
        }
    }
    ...
    public function wallet(string $id): JsonResponse
    {
        try {
            ...
            return ShopittPlus::response(true, 'User wallet retrieved successfully', 200, (object) ['wallet' => $wallet]);
        } catch (InvalidArgumentException $e) {
            Log::error('GET USER WALLET: Error Encountered: ' . $e->getMessage());
            return ShopittPlus::response(false, $e->getMessage(), 400);
        } catch (Exception $e) {
            Log::error('GET USER WALLET: Error Encountered: ' . $e->getMessage());
            return ShopittPlus::response(false, 'Failed to retrieve user wallet', 500);
        }
    }
