...
class AdminServiceManagementController extends Controller
{
    ...
    public function airtimeStatistics(Request $request): JsonResponse
    {
        try {
            ...
            return TransactX::response(true, 'Airtime statistics retrieved successfully', 200, $statistics);
        } catch (Exception $e) {
            Log::error('ADMIN AIRTIME STATISTICS: Error Encountered: ' . $e->getMessage());
            return TransactX::response(false, 'Failed to retrieve airtime statistics', 500);
        }
    }
    ...
    public function airtimeIndex(Request $request): JsonResponse
    {
        try {
            ...
            return TransactX::response(true, 'Airtime transactions retrieved successfully', 200, $transactions);
        } catch (Exception $e) {
            Log::error('ADMIN AIRTIME INDEX: Error Encountered: ' . $e->getMessage());
            return TransactX::response(false, 'Failed to retrieve airtime transactions', 500);
        }
    }
    ...
    public function airtimeShow(string $id): JsonResponse
    {
        try {
            ...
            return TransactX::response(true, 'Airtime transaction retrieved successfully', 200, $transaction);
        } catch (Exception $e) {
            ...
            return TransactX::response(false, 'Failed to retrieve airtime transaction', 500);
        }
    }
    ...
    public function airtimeNetworks(): JsonResponse
    {
        try {
            ...
            return TransactX::response(true, 'Airtime networks retrieved successfully', 200, $networks);
        } catch (Exception $e) {
            Log::error('ADMIN GET AIRTIME NETWORKS: Error Encountered: ' . $e->getMessage());
            return TransactX::response(false, 'Failed to retrieve airtime networks', 500);
        }
    }
    ...
    public function dataStatistics(Request $request): JsonResponse
    {
        try {
            ...
            return TransactX::response(true, 'Data statistics retrieved successfully', 200, $statistics);
        } catch (Exception $e) {
            Log::error('ADMIN DATA STATISTICS: Error Encountered: ' . $e->getMessage());
            return TransactX::response(false, 'Failed to retrieve data statistics', 500);
        }
    }
    ...
    public function dataIndex(Request $request): JsonResponse
    {
        try {
            ...
            return TransactX::response(true, 'Data transactions retrieved successfully', 200, $transactions);
        } catch (Exception $e) {
            Log::error('ADMIN DATA INDEX: Error Encountered: ' . $e->getMessage());
            return TransactX::response(false, 'Failed to retrieve data transactions', 500);
        }
    }
    ...
    public function dataShow(string $id): JsonResponse
    {
        try {
            ...
            return TransactX::response(true, 'Data transaction retrieved successfully', 200, $transaction);
        } catch (Exception $e) {
            if ($e->getMessage() === 'Data transaction not found') {
                return TransactX::response(false, $e->getMessage(), 404);
            }
            Log::error('ADMIN GET DATA TRANSACTION: Error Encountered: ' . $e->getMessage());
            return TransactX::response(false, 'Failed to retrieve data transaction', 500);
        }
    }
    ...
    public function electricityStatistics(Request $request): JsonResponse
    {
        try {
            ...
            return TransactX::response(true, 'Electricity statistics retrieved successfully', 200, $statistics);
        } catch (Exception $e) {
            Log::error('ADMIN ELECTRICITY STATISTICS: Error Encountered: ' . $e->getMessage());
            return TransactX::response(false, 'Failed to retrieve electricity statistics', 500);
        }
    }
    ...
    public function electricityIndex(Request $request): JsonResponse
    {
        try {
            ...
            return TransactX::response(true, 'Electricity transactions retrieved successfully', 200, $transactions);
        } catch (Exception $e) {
            Log::error('ADMIN ELECTRICITY INDEX: Error Encountered: ' . $e->getMessage());
            return TransactX::response(false, 'Failed to retrieve electricity transactions', 500);
        }
    }
    ...
    public function electricityShow(string $id): JsonResponse
    {
        try {
            ...
            return TransactX::response(true, 'Electricity transaction retrieved successfully', 200, $transaction);
        } catch (Exception $e) {
            ...
            return TransactX::response(false, 'Failed to retrieve electricity transaction', 500);
        }
    }
    ...
    public function tvStatistics(Request $request): JsonResponse
    {
        try {
            ...
            return TransactX::response(true, 'TV statistics retrieved successfully', 200, $statistics);
        } catch (Exception $e) {
            Log::error('ADMIN TV STATISTICS: Error Encountered: ' . $e->getMessage());
            return TransactX::response(false, 'Failed to retrieve TV statistics', 500);
        }
    }
    ...
    public function tvIndex(Request $request): JsonResponse
    {
        try {
            ...
            return TransactX::response(true, 'TV transactions retrieved successfully', 200, $transactions);
        } catch (Exception $e) {
            Log::error('ADMIN TV INDEX: Error Encountered: ' . $e->getMessage());
            return TransactX::response(false, 'Failed to retrieve TV transactions', 500);
        }
    }
    ...
    public function tvShow(string $id): JsonResponse
    {
        try {
            ...
            return TransactX::response(true, 'TV transaction retrieved successfully', 200, $transaction);
        } catch (Exception $e) {
            if ($e->getMessage() === 'TV transaction not found') {
                return TransactX::response(false, $e->getMessage(), 404);
            }
            Log::error('ADMIN GET TV TRANSACTION: Error Encountered: ' . $e->getMessage());
            return TransactX::response(false, 'Failed to retrieve TV transaction', 500);
        }
    }
    ...
    public function tvProviders(): JsonResponse
    {
        try {
            ...
            return TransactX::response(true, 'TV providers retrieved successfully', 200, $providers);
        } catch (Exception $e) {
            Log::error('ADMIN GET TV PROVIDERS: Error Encountered: ' . $e->getMessage());
            return TransactX::response(false, 'Failed to retrieve TV providers', 500);
        }
    }
    ...
    public function electricityProviders(): JsonResponse
    {
        try {
            ...
            return TransactX::response(true, 'Electricity providers retrieved successfully', 200, $providers);
        } catch (Exception $e) {
            Log::error('ADMIN GET ELECTRICITY PROVIDERS: Error Encountered: ' . $e->getMessage());
            return TransactX::response(false, 'Failed to retrieve electricity providers', 500);
        }
    }
    ...
    public function dataProviders(): JsonResponse
    {
        try {
            ...
            return TransactX::response(true, 'Data providers retrieved successfully', 200, $providers);
        } catch (Exception $e) {
            Log::error('ADMIN GET DATA PROVIDERS: Error Encountered: ' . $e->getMessage());
            return TransactX::response(false, 'Failed to retrieve data providers', 500);
        }
    }
}