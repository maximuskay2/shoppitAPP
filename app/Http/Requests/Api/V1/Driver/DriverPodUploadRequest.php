...
class DriverPodUploadRequest extends FormRequest
{
    ...
    public function prepareForValidation(): void
    {
        ...
        Log::channel('daily')->info(
            'DRIVER POD UPLOAD REQUEST: START',
    ...
    public function rules(): array
    {
        return [
            ...
            'signature' => ['nullable', 'file', 'mimes:jpeg,png,jpg', 'max:5120'],
        ];
    }
    ...
    public function failedValidation(Validator $validator): void
    {
        ...
        Log::channel('daily')->info(
            'DRIVER POD UPLOAD REQUEST: VALIDATION',
