...
class OrderCompletedNotification extends Notification implements ShouldQueue
{
    ...
    {
        return (new MailMessage)->subject('Order Completed Successfully! 🎉')
            ->view(
                'email.user.order.order-completed',
                [
                    'user' => $notifiable,
                    'order' => $this->order,
    ...
    public function toFCM(object $notifiable): CloudMessage
    {
        ...
        $body = "Your order {$this->order->tracking_id} has been completed successfully. Thank you for shopping with us!";
        ...
        return CloudMessage::new()
            ...
            ->withData([
                'notification_key' => 'order-completed',
