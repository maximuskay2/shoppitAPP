...
class OrderPlacedSuccessfullyNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return (new MailMessage)->subject('Order Placed Successfully 🛍️')
            ->view(
                'email.user.order.order-placed-successfully',
                [
                    'user' => $notifiable,
                    'order' => $this->order,
    ...
    public function toFCM(object $notifiable): CloudMessage
    {
        ...
        $body = "Your order {$this->order->tracking_id} has been placed successfully. Total: {$this->currency} " . number_format($this->netTotal, 2);
