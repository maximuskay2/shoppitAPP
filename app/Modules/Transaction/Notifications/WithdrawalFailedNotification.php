...
class WithdrawalFailedNotification extends Notification implements ShouldQueue
{
    ...
    {
        return (new MailMessage)->subject('Withdrawal Failed - Funds Returned 💳')
            ->view(
                'email.user.wallet.withdrawal-failed',
                [
                    'user' => $notifiable,
    ...
    public function toFCM(object $notifiable): CloudMessage
    {
        ...
        $body = "Your withdrawal of {$this->currency} " . number_format($this->amount, 2) . " failed. Funds have been returned to your wallet.";
        ...
        return CloudMessage::new()
            ...
            ->withData([
                'notification_key' => 'withdrawal-failed',
