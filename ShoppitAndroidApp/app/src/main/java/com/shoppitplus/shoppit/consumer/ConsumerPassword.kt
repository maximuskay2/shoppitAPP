...
import com.shoppitplus.shoppit.databinding.FragmentConsumerPasswordBinding
...
class ConsumerPassword : Fragment() {
    private var _binding: FragmentConsumerPasswordBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentConsumerPasswordBinding.inflate(inflater, container, false)
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            try {
                ...
                if (response.success) {
                    ...
                    findNavController().navigate(R.id.action_consumerPassword_to_login)
                } else {
                    Toast.makeText(requireContext(), response.message, Toast.LENGTH_LONG).show()
                }
