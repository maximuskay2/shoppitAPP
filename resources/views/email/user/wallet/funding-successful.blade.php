...
<html lang="en">
  <body style="margin:0; padding:0; background:#F5F7FB; color:#1F2937;">
    <div style="display:none; font-size:1px; color:#F5F7FB; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden;">
      Your wallet has been successfully funded with {{ $transactionCurrency }} {{ number_format($transactionAmount, 2) }}.
    </div>
              ...
              <td style="padding:28px 24px;">
                <div style="font-family:Arial,Helvetica,sans-serif; font-size:16px; line-height:1.6; color:#1F2937;">
                  ...
                  <p style="margin:0 0 16px;">
                    ...
                    <strong style="color:#2C9139;">{{ $transactionCurrency }} {{ number_format($transactionAmount, 2) }}</strong>. 
                    Thank you for using ShopittPlus! 💰
                  </p>
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="background:#F0F9F2; border:1px solid #D1E7D7; border-radius:10px; padding:16px; margin:16px 0 20px;">
                    ...
                    <tr>
                      <td style="font-family:Arial,Helvetica,sans-serif; font-size:14px; color:#374151; padding:10px 0; border-bottom:1px solid #E8F5EA; width:50%;">Status</td>
                    ...
                    <tr>
                      <td style="font-family:Arial,Helvetica,sans-serif; font-size:14px; color:#374151; padding:10px 0;">New Balance</td>
                      <td style="font-family:Arial,Helvetica,sans-serif; font-size:14px; color:#2C9139; font-weight:700; padding:10px 0; text-align:right;">{{ $transactionCurrency }} {{ number_format($walletAmount, 2) }}</td>
                    </tr>
                  </table>

                  <p style="margin:0 0 8px; font-size:14px; color:#4B5563;">
                    Your wallet is now ready to use for purchases on ShopittPlus. If you have any questions about this transaction, please contact our support team.
                  </p>
