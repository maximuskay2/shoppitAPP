              ...
              <td style="padding:28px 24px;">
                <div style="font-family:Arial,Helvetica,sans-serif; font-size:16px; line-height:1.6; color:#1F2937;">
                  ...
                  <p style="margin:0 0 16px;">
                    ...
                    <strong style="color:#2C9139;">{{ $transaction->currency }} {{ number_format($transaction->amount->getAmount()->toFloat(), 2) }}</strong> 
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="background:#F0F9F2; border:1px solid #D1E7D7; border-radius:10px; padding:16px; margin:16px 0 20px;">
                    ...
                    <tr>
                      ...
                      <td style="font-family:Arial,Helvetica,sans-serif; font-size:14px; color:#2C9139; font-weight:700; padding:10px 0; border-bottom:1px solid #E8F5EA; text-align:right;">{{ $transaction->currency }} {{ number_format($transaction->amount->getAmount()->toFloat(), 2) }}</td>
                    </tr>
                    
                    <tr>
                      <td style="font-family:Arial,Helvetica,sans-serif; font-size:14px; color:#374151; padding:10px 0; border-bottom:1px solid #E8F5EA;">Billed Amount</td>
                      <td style="font-family:Arial,Helvetica,sans-serif; font-size:14px; color:#2C9139; font-weight:700; padding:10px 0; border-bottom:1px solid #E8F5EA; text-align:right;">{{ $transaction->currency }} {{ number_format($billed_at, 2) }}</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td style="font-family:Arial,Helvetica,sans-serif; font-size:14px; padding:10px 0; border-bottom:1px solid #E8F5EA; text-align:right;">
                        <span style="background:#10b981; color:#ffffff; padding:4px 12px; border-radius:20px; font-size:12px; font-weight:600;">{{ $transaction->status }}</span>
                      </td>
                    </tr>
                    
                    <tr>
                      <td style="font-family:Arial,Helvetica,sans-serif; font-size:14px; color:#374151; padding:10px 0; border-bottom:1px solid #E8F5EA;">Balance Remains</td>
                      <td style="font-family:Arial,Helvetica,sans-serif; font-size:14px; color:#2C9139; font-weight:700; padding:10px 0; border-bottom:1px solid #E8F5EA; text-align:right;">{{ $wallet->currency }} {{ number_format($wallet->amount->getAmount()->toFloat(), 2) }}</td>
                    </tr>
                    
                    @if($transaction->feeTransactions()->count() > 0)
                    <tr>
                      <td style="font-family:Arial,Helvetica,sans-serif; font-size:14px; color:#374151; padding:10px 0;">Transaction Fee</td>
                      <td style="font-family:Arial,Helvetica,sans-serif; font-size:14px; color:#111827; padding:10px 0; text-align:right;">{{ $transaction->currency }} {{ number_format($transaction->feeTransactions()->first()->amount->getAmount()->toFloat(), 2) }}</td>
                    </tr>
                    @endif
                  </table>
