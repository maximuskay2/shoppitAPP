...
<head>
  ...
  <title>Subscription Revert Warning - TransactX</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    @media (prefers-color-scheme: dark) {
      ...
      .header-text, .highlight, .countdown-time { color: #f472b6; }
...
<body>
  <div class="email-container">
    ...
    <div class="header">
      ...
      <p class="header-text">⚠️ Subscription Revert Warning</p>
    </div>
    ...
    <div class="content">
      ...
      <div class="status-message">Your subscription grace period is ending soon.</div>

      <div class="countdown">
        <div class="countdown-label">Time Remaining</div>
        <div class="countdown-time">7 Days</div>
        <div class="countdown-plan">Reverting to: {{ ucfirst($model->name->value) }}</div>
      </div>

      <div class="message">
        Your subscription will revert to the <span class="highlight">{{ ucfirst($model->name->value) }}</span> plan after your grace period.  
      ...
      <div class="list">
        <div class="list-item">
          ...
          <div class="list-text"><strong>Data Loss:</strong> Any excess data will be deleted after reversion.</div>
        </div>
        <div class="list-item">
          <div class="list-icon">🔒</div>
          <div class="list-text"><strong>Limited Access:</strong> Some premium features will be unavailable.</div>
        </div>
        <div class="list-item">
          <div class="list-icon">📦</div>
          <div class="list-text"><strong>Reduced Storage:</strong> Storage capacity will match the reverted plan.</div>
        </div>
      </div>

      <div class="cta-message">
        Renew your subscription now to maintain your current plan and prevent data loss.
      </div>
