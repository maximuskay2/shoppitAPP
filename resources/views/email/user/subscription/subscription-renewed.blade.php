...
<head>
  ...
  <title>Subscription Renewed - TransactX</title>
  <style>
...
<body>
  <div class="email-container">
    ...
    <div class="header">
      ...
      <p class="header-text"> Subscription Renewed</p>
    </div>
    ...
    <div class="content">
      ...
      <div class="status-message">Your subscription has been renewed successfully!</div>

      <div class="message">
        You’ve successfully renewed your <span class="highlight">{{ ucfirst($plan) }}</span> plan.
        Your premium access continues seamlessly — no action required.
      </div>
      ...
      <div class="cta-message">
        You can view your updated subscription anytime from your dashboard.
      </div>
