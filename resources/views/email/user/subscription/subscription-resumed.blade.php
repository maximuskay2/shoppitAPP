...
<head>
  ...
  <title>Subscription Resumed - TransactX</title>
  <style>
...
<body>
  <div class="email-container">
    ...
    <div class="header">
      ...
      <p class="header-text">▶️ Subscription Resumed</p>
    </div>
    ...
    <div class="content">
      ...
      <div class="status-message">Welcome back! Your subscription is active again</div>

      <div class="message">
        Great news! Your <span class="highlight">{{ ucfirst($model->name->value) }}</span> plan subscription has been successfully resumed. 
      ...
      <div class="details">
        ...
        <div class="detail-row">
          <span class="detail-label">Resumed On</span>
