...
<head>
  ...
  <title>Subscription Processing - TransactX</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .highlight { color: #AB0B4B; font-weight: 600; }
    ...
    @media (prefers-color-scheme: dark) {
      ...
      .subscription-details { background-color: #1f2937; border-color: #374151; }
      .detail-label { color: #d1d5db; }
      .detail-value { color: #f9fafb; }
      .processing-badge { background-color: #fbbf24; color: #111827; }
      .amount { color: #f472b6; }
...
<body>
  <div class="email-container">
    ...
    <div class="header">
      ...
      <p class="header-text">Subscription Processing ⏳</p>
    </div>
    ...
    <div class="content">
      ...
      <div class="subscription-details">
        ...
        <div class="detail-row">
          ...
          <span class="detail-value"><span class="processing-badge">{{ $transaction->status }}</span></span>
        </div>
        <div class="detail-row">
      ...
      <div class="message1">
        Thank you for choosing <span class="highlight">TransactX</span>! 🚀
      </div>
    </div>
